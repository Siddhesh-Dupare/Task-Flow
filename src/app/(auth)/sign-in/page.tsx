...
// Icons
import { Mail, Lock, Eye, EyeOff, MoveRight, Loader2 } from "lucide-react";
...
const SignInForm: React.FC = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // On successful sign-in, redirect the user to the projects dashboard
  ...
  const handleSocialSignIn = async (provider: "google" | "github") => {
    ...
    try {
      ...
      setIsLoading(false); // Only set loading false if there's an error
    }
  };
